...
let RecommendService = class RecommendService {
    ...
    async latestRecoommend() {
        return await (0, rxjs_1.firstValueFrom)(this.httpService.get(process.env.RECOMMEND_SERVICE + '/api/latest').pipe((0, rxjs_1.map)(res => res.data)));
    }
};
